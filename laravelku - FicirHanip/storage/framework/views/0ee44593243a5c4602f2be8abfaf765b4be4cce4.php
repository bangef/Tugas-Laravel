                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?php echo e(route('anggota.destroy',$agot->id)); ?>">
                            ...
                            <a class="btn btn-info" href="<?php echo e(route('anggota.show',$agot->id)); ?>">Detail</a>
                            <a class="btn btn-warning" href="<?php echo e(route('anggota.edit',$agot->id)); ?>">Ubah</a>
                            <button class="btn btn-danger" onclick="return confirm('Anda Ingin Menghapus Data Ini?')">Hapus</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_laravel\resources\views/anggota/index.blade.php ENDPATH**/ ?>