...
?>
    ...
    <a class="btn btn-primary btn-md" href="<?php echo e(url('anggota.create')); ?>" role="button">Tambah Data</a>
    <br/>
        ...
        <tbody>
            <?php $__currentLoopData = $ar_anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?php echo e(url('anggota.destroy',$agot->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('delete'); ?>
                            <a class="btn btn-info" href="<?php echo e(url('anggota.show',$agot->id)); ?>"><i class="fas fa-info-circle"></i></a>
                            <a class="btn btn-warning" href="<?php echo e(url('anggota.edit',$agot->id)); ?>"><i class="fas fa-user-edit"></i></a>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_laravel_yusuffadillah\resources\views/anggota/index.blade.php ENDPATH**/ ?>